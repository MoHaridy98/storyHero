                    ...
                    <div class="slides-1 swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="item">
                                    <h3 class="mb-3">فى لقاء أشرف عطية بأصحاب ذوى الهمم .. دعم وتعزيز حقوقهم ويطالبهم بإستثمار قدراتهم في تنفيذ مشروعات صغيرة ومتناهية الصغر</h3>
                                    <p>فى إطار حرصه على التواصل الجماهيرى المباشر مع كافة فئات المجتمع الأسوانى ألتقى اللواء أشرف عطية محافظ أسوان مجموعة شباب من ذوى الهمم حيث أكد على دعم ورعاية المحافظة للشباب بمختلف فئاتهم وخاصة أصحاب ذوى القدرات الخاصة الذين يتسلحوا بالإرادة الصلبة والتصميم والعزيمة فى مواجهة تحديات الحياة.</p>
                                </div>
                            </div>
                            <!-- End slide item -->
                            <div class="swiper-slide">
                                <div class="item">
                                    <h3 class="mb-3">للأسبوع الثالث على التوالي ووسط مشاعر الأبوة والإنسانية .. محافظ أسوان يشارك أبناءه من دور الرعاية الاجتماعية وذوى الهمم حفل الإفطار الرمضانى .. ويؤكد على دعمه وتلبية تطلعاتهم ومطالبهم </h3>
                                    <p>وخلال حفل الإفطار قام اللواء أشرف عطية بتبادل الحديث مع أبناءه من دور الرعاية الإجتماعية للإطمئنان على مستوى الخدمات المقدمة لهم ، وتوفير كافة أوجه الرعاية الطبية والمعيشية ، وهو الذى يتوازى مع توجيه المحافظ التهنئة للمتفوقين من ذوى الهمم على ما حققوه من المراكز الأول بمختلف المسابقات والبطولات على مستوى الجمهورية ليثبوا بأنهم " قادرون بإختلاف "</p>
                                </div>
                            </div>
                            <!-- End slide item -->
                            <div class="swiper-slide">
                                <div class="item">
                                    <h3 class="mb-3">محافظ أسوان : فعاليات رياضية لدعم ذوى الهمم وإختيار دفعة جديدة بالمشروع القومى للموهبة والبطل الأوليمبى في لعبة كرة السلة .. وأنشطة ثقافية وفنية متنوعة بمدن ومراكز المحافظة</h3>
                                    <p>فى ظل الإهتمام الأبوى الذى يوليه الرئيس عبد الفتاح السيسى لأبناءه من ذوى الهمم  " قادرون بإختلاف " أعطى اللواء أشرف عطية محافظ أسوان توجيهاته للمديريات الخدمية والجهات المختصة بمواصلة تنظيم العديد من الفعاليات والأنشطة وذلك بهدف العمل على رفع كفاءاتهم وتنمية مهاراتهم من خلال توفير الخدمات التدريبية والتأهيلية لهم ، </p>
                                </div>
                            </div>
                            <!-- End slide item -->
                            <div class="swiper-slide">
                                <div class="item">
                                    <h3 class="mb-3">محافظ أسوان : يكرم حفظة القرآن الكريم من ذوى الهمم .. ويوجه لتنظيم إحتفالية كبرى بإشراف من الأزهر الشريف لتكريم الأوائل على مستوى المعاهد الأزهرية والكتاتيب</h3>
                                    <p>فى إطار إهتمامه بالمواهب والمهارات الشخصية لذوى الهمم " والقادرين بإختلاف " قام اللواء أشرف عطية محافظ أسوان بتكريم حفظة القرآن الكريم من المكفوفين الطالبة إبتسام محمد فوزى 14 سنة بالصف الثالث الإعدادى ، وأيضاً الطالب عمار إسلام عبد الودود 11 سنة بالصف الأول الإعدادى وهما بمعهد فتيات الصعايدة قبلى الإعدادى الأزهرى بمركز إدفو حيث شمل التكريم إهداء درع المحافظة لهما ، مع صرف مكافأة مالية قيمة لهم.</p>
                                </div>
                            </div>
                            <!-- End slide item -->
                            <div class="swiper-slide">
                                <div class="item">
                                    <h3 class="mb-3">توزيع درجات بخارية على ذوى الهمم  .. ومحافظ أسوان : في إطار مبادرة 2021 عاماً لذوى الإعاقة</h3>
                                    <p>ضمن فعاليات عيد أسوان القومى وإهتمام المحافظة بجميع فئات المجتمع الأسوانى وفى مقدمتهم ذوى الهمم من أصحاب القدرات الخاصة كلف اللواء أشرف عطية محافظ أسوان الدكتورة غادة أبو زيد نائب المحافظ بتوزيع وتسليم 6 درجات بخارية للمستحقين من ذوى الإعاقة ممن تقدموا بطلبات للحصول علي دراجة مجهزة ، والذين إنطبقت عليهم الشروط والمعايير ،حيث يأتى ذلك فى إطار المبادرة التى أطلقها محافظ أسوان بإعتبار 2021 عاماً للأشخاص ذوى الإعاقة بالمحافظة</p>
                                </div>
                            </div>
                            <!-- End slide item -->
                        </div>
