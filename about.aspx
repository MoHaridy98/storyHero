...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background: url('assets/img/about-header1.jpg') center no-repeat; background-size:cover;">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-5"  style="text-align: center">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="card-item" style="box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 2px 0px;">
                        <div class="row">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="card-item" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 d-flex align-items-center">
                                <div class="card-body">
                                    ...
                                    <p>توفير معلمين ومختصين ذوي كفاءة عالية في تعليم أصحاب الهمم في مختلف اعاقات والمراحل الدراسية</p>
                                </div>
                            </div>
                        </div>
                    </div>
