            ...
            if (readers.HasRows)
            {
                while (readers.Read())
                {
                    if (readers[0].Equals(0))
                    {
                        ...
                        img1.Style.Add("background", "url('assets/img/index_news/" + readers[3].ToString() + "') center");
                    }
                    if (readers[0].Equals(1))
                    {
                        news2.InnerText = readers[1].ToString();
                        desc2.InnerText = readers[2].ToString();
                        img2.Style.Add("background", "url('assets/img/index_news/" + readers[3].ToString() + "') center");
                    }
                    if (readers[0].Equals(2))
                    {
                        news3.InnerText = readers[1].ToString();
                        desc3.InnerText = readers[2].ToString();
                        img3.Style.Add("background", "url('assets/img/index_news/" + readers[3].ToString() + "') center");
                    }
                    if (readers[0].Equals(3))
                    {
                        news4.InnerText = readers[1].ToString();
                        desc4.InnerText = readers[2].ToString();
                        img4.Style.Add("background", "url('assets/img/index_news/" + readers[3].ToString() + "') center");
                    }
                    if (readers[0].Equals(4))
                    {
                        news5.InnerText = readers[1].ToString();
                        desc5.InnerText = readers[2].ToString();
                        img5.Style.Add("background", "url('assets/img/index_news/" + readers[3].ToString() + "') center");
                    }
                }
            }
        }
